...
enum {
    kCTTextAlignmentLeft = kCTLeftTextAlignment,
    kCTTextAlignmentRight = kCTRightTextAlignment,
    kCTTextAlignmentCenter = kCTCenterTextAlignment,
    kCTTextAlignmentJustified = kCTJustifiedTextAlignment,
    kCTTextAlignmentNatural = kCTNaturalTextAlignment,
};
