...
- (id) initWithAndroidApp:(struct android_app*)android
{
    ...
    if (self) {
        ...
        self.documentsDir = @"/home/ethan/Downloads";
#else
		self.documentsDir = @"/home/ethan/Downloads";
#endif
        ...
        // TODO: Get Cricket Audio working
...
- (void) maybeInitSurface
{
    ...
    if(!_sdlwindow) {
        _sdlwindow = SDL_CreateWindow("APKit Application",
            SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 640, 480, 0);
    }

    if (_surface == EGL_NO_SURFACE && _sdlwindow) {
